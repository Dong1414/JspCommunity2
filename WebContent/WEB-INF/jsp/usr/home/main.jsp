		...
		<div class="sbs-2021-slider sbs-2021-slider-1">
			...
			<div class="items-wrap">
				<div class="items">
					...
					<div>
						<a class="bg cook-image" href="../article/list?boardId=2">
							<span></span>
						</a>
					</div>
					<div>
						<a class="bg bug-image" href="../article/list?boardId=2">
							<span></span>
						</a>

					</div>
					<div>
						<a class="bg single-image" href="../article/list?boardId=2">
							<span></span>
						</a>

					</div>
					<div>
						<a class="bg tip-image" href="../article/list?boardId=2">
							<span></span>
						</a>

					</div>
					<div>
						<a class="bg question-image" href="../article/list?boardId=2">
							<span></span>
						</a>

					</div>
					<div>
						<a class="bg notice-image" href="../article/list?boardId=2">
							<span></span>
						</a>
